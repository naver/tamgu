...
#ifndef Tamgua_mapfi_h
#define Tamgua_mapfi_h
...
class Tamgua_mapfi;
//This typedef defines a type "a_mapfiMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgua_mapfi::*a_mapfiMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgua_mapfi : public TamguContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<a_mapfiMethod> methods;
    ...
    atomic_map<double, long> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgua_mapfi(TamguGlobal* g, Tamgu* parent = NULL) : TamguContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Tamgua_mapfi * m = new Tamgua_mapfi;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(TamguGlobal* global, string name, a_mapfiMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgua_mapfi::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationa_mapfi : public TamguIteration {
    public:
    ...
    short indexarray;
    bool end;
    atomic_element<double, long>* e;
    uchar idx;
    BULONG filter;
    
    Tamgua_mapfi* mm;
    
    TamguIterationa_mapfi(Tamgua_mapfi* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        mm = m;
        end = false;
        i = 0;
        idx = 255;
    ...
    bool compare(TamguIterationa_mapfi& it) {
