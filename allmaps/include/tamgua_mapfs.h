...
#ifndef Tamgua_mapfs_h
#define Tamgua_mapfs_h
...
class Tamgua_mapfs;
//This typedef defines a type "a_mapfsMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgua_mapfs::*a_mapfsMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgua_mapfs : public TamguContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<a_mapfsMethod> methods;
    ...
    atomic_map<double, atomic_string> values;
    bool isconst;
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Tamgua_mapfs * m = new Tamgua_mapfs;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(TamguGlobal* global, string name, a_mapfsMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgua_mapfs::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationa_mapfs : public TamguIteration {
    public:
    ...
    short indexarray;
    bool end;
    atomic_element<double, atomic_string>* e;
    uchar idx;
    BULONG filter;
    
    Tamgua_mapfs* mm;
    
    TamguIterationa_mapfs(Tamgua_mapfs* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        mm = m;
        end = false;
        i = 0;
        idx = 255;
    ...
    bool compare(TamguIterationa_mapfs& it) {
