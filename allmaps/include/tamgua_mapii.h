...
#ifndef Tamgua_mapii_h
#define Tamgua_mapii_h
...
class Tamgua_mapii;
//This typedef defines a type "a_mapiiMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgua_mapii::*a_mapiiMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgua_mapii : public TamguContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<a_mapiiMethod> methods;
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Tamgua_mapii * m = new Tamgua_mapii;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(TamguGlobal* global, string name, a_mapiiMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgua_mapii::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationa_mapii : public TamguIteration {
    public:
    ...
    short indexarray;
    bool end;
    atomic_element<long, long>* e;
    uchar idx;
    BULONG filter;
    
    Tamgua_mapii* mm;
    
    TamguIterationa_mapii(Tamgua_mapii* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        mm = m;
        end = false;
        i = 0;
        idx = 255;
    ...
    bool compare(TamguIterationa_mapii& it) {
