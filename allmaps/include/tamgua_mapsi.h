...
#ifndef Tamgua_mapsi_h
#define Tamgua_mapsi_h
...
class Tamgua_mapsi;
//This typedef defines a type "a_mapsiMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgua_mapsi::*a_mapsiMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgua_mapsi : public TamguContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<a_mapsiMethod> methods;
    ...
    atomic_map<string, long> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgua_mapsi(TamguGlobal* g, Tamgu* parent = NULL) : TamguContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Tamgua_mapsi * m = new Tamgua_mapsi;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(TamguGlobal* global, string name, a_mapsiMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgua_mapsi::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationa_mapsi : public TamguIteration {
    public:
    ...
    short indexarray;
    bool end;
    atomic_element<string, long>* e;
    uchar idx;
    BULONG filter;
    
    Tamgua_mapsi* mm;
    
    TamguIterationa_mapsi(Tamgua_mapsi* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        mm = m;
        end = false;
        i = 0;
        idx = 255;
    ...
    bool compare(TamguIterationa_mapsi& it) {
