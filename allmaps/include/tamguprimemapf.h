...
#ifndef Tamguprimemapf_h
#define Tamguprimemapf_h
...
class Tamguprimemapf;
//This typedef defines a type "primemapfMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemapf::*primemapfMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemapf : public TamguObjectLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemapfMethod> methods;
    ...
    prime_hash<double, Tamgu*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemapf(TamguGlobal* g, Tamgu* parent = NULL) : TamguObjectLockContainer(g, parent) {
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        prime_hash<double,Tamgu*>::iterator ist;
    ...
    Tamgu* Newinstance(short idthread, Tamgu* f = NULL) {
        return new Tamguprimemapf();
    }

    Exporting TamguIteration* Newiteration(bool direction);


    static void AddMethod(TamguGlobal* global, string name, primemapfMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<double, Tamgu*>::iterator itr;
        Tamguprimemapf* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr = values.begin(); itr != values.end(); itr++) {
            item = new Tamguprimemapf;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemapf::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemapf : public TamguIteration {
    public:
    ...
    TamguIterationprimemapf(Tamguprimemapf* m, bool d, TamguGlobal* g = NULL) : map(m), _lock(m), TamguIteration(d, g) {}
