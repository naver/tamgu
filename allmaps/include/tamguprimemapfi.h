...
#ifndef Tamguprimemapfi_h
#define Tamguprimemapfi_h
...
class Tamguprimemapfi;
//This typedef defines a type "primemapfiMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemapfi::*primemapfiMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemapfi : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemapfiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemapfi(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamguprimemapfi * m = new Tamguprimemapfi;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    double Sum() {
        locking();
        double v = 0;
        prime_hash<double, long>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        if (a->isContainer()) {
            ...
            for (it->Begin(); it->End() == aFALSE; it->Next()) {
                m->values[it->Keyfloat()]=it->Valueinteger();
            }
            it->Release();
            return m;
        }
        ...
        long val=a->Integer();
        prime_hash<double,long>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, primemapfiMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<double, long>::iterator itr;
        Tamguprimemapfi* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Tamguprimemapfi;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemapfi::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(string& n) {
        ...
        Tamgu* res = globalTamgu->Provideint(values[v]);
        unlocking();
        return res;        
    }
    ...
    Tamgu* Value(long n) {
        ...
        Tamgu* res = globalTamgu->Provideint(values[(double)n]);
        unlocking();
        return res;        
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemapfi : public TamguIteration {
    public:

    prime_hash<double, long>::iterator it;
    Tamguprimemapfi map;

    TamguIterationprimemapfi(Tamguprimemapfi* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
