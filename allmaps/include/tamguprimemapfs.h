...
#ifndef Tamguprimemapfs_h
#define Tamguprimemapfs_h
...
class Tamguprimemapfs;
//This typedef defines a type "primemapfsMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemapfs::*primemapfsMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemapfs : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemapfsMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemapfs(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamguprimemapfs * m = new Tamguprimemapfs;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        string val=a->String();
        prime_hash<double,string>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, primemapfsMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<double, string>::iterator itr;
        Tamguprimemapfs* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Tamguprimemapfs;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemapfs::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(long n) {
        ...
        Tamgu* res = globalTamgu->Providestring(values[(double)n]);
        unlocking();
        return res;        
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemapfs : public TamguIteration {
    public:

    prime_hash<double, string>::iterator it;
    Tamguprimemapfs map;

    TamguIterationprimemapfs(Tamguprimemapfs* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
