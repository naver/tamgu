...
#ifndef Tamguprimemapl_h
#define Tamguprimemapl_h
...
class Tamguprimemapl;
//This typedef defines a type "primemaplMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemapl::*primemaplMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemapl : public TamguObjectLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemaplMethod> methods;
    ...
    prime_hash<BLONG, Tamgu*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemapl(TamguGlobal* g, Tamgu* parent = NULL) : TamguObjectLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced) {
            Tamguprimemapl* m = new Tamguprimemapl;
            locking();
            Tamgu* v;
            prime_hash<BLONG, Tamgu*>::iterator it;
            for (it = values.begin(); it != values.end(); it++) {
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        prime_hash<BLONG,Tamgu*>::iterator ist;
    ...
    Tamgu* Newinstance(short idthread, Tamgu* f = NULL) {
        return new Tamguprimemapl();
    }

    Exporting TamguIteration* Newiteration(bool direction);


    static void AddMethod(TamguGlobal* global, string name, primemaplMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<BLONG, Tamgu*>::iterator itr;
        Tamguprimemapl* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Tamguprimemapl;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemapl::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemapl : public TamguIteration {
    public:
    ...
    TamguIterationprimemapl(Tamguprimemapl* m, bool d, TamguGlobal* g = NULL) : map(m), _lock(m), TamguIteration(d, g) {}
