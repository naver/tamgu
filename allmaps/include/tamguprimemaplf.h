...
#ifndef Tamguprimemaplf_h
#define Tamguprimemaplf_h
...
class Tamguprimemaplf;
//This typedef defines a type "primemaplfMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemaplf::*primemaplfMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemaplf : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemaplfMethod> methods;
    ...
    prime_hash<BLONG, double> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemaplf(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamguprimemaplf * m = new Tamguprimemaplf;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    double Sum() {
        locking();
        double v = 0;
        prime_hash<BLONG, double>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        double val=a->Float();
        prime_hash<BLONG,double>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, primemaplfMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<BLONG, double>::iterator itr;
        Tamguprimemaplf* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Tamguprimemaplf;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemaplf::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(Tamgu* a) {
        ...
        Tamgu* res = globalTamgu->Providefloat(values[(BLONG)n]);
        unlocking();
        return res;        
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemaplf : public TamguIteration {
    public:

    prime_hash<BLONG, double>::iterator it;
    Tamguprimemaplf map;

    TamguIterationprimemaplf(Tamguprimemaplf* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
