...
#ifndef Tamguprimemaplu_h
#define Tamguprimemaplu_h
...
class Tamguprimemaplu;
//This typedef defines a type "primemapluMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemaplu::*primemapluMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemaplu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemapluMethod> methods;
    ...
    prime_hash<BLONG, wstring> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemaplu(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamguprimemaplu * m = new Tamguprimemaplu;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        prime_hash<BLONG,wstring>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, primemapluMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<BLONG, wstring>::iterator itr;
        Tamguprimemaplu* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Tamguprimemaplu;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemaplu::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(Tamgu* a) {
        ...
        Tamgu* res = globalTamgu->Provideustring(values[(BLONG)n]);
        unlocking();
        return res;        
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemaplu : public TamguIteration {
    public:

    prime_hash<BLONG, wstring>::iterator it;
    Tamguprimemaplu map;

    TamguIterationprimemaplu(Tamguprimemaplu* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
