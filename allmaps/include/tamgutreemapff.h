...
#ifndef Tamgutreemapff_h
#define Tamgutreemapff_h
...
class Tamgutreemapff;
//This typedef defines a type "treemapffMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapff::*treemapffMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapff : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapffMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapff(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapff * m = new Tamgutreemapff;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        double val=a->Float();
        map<double,double>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapffMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapff::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapff : public TamguIteration {
    public:

    map<double, double>::iterator it;
    Tamgutreemapff map;

    TamguIterationtreemapff(Tamgutreemapff* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
