...
#ifndef Tamgutreemapfi_h
#define Tamgutreemapfi_h
...
class Tamgutreemapfi;
//This typedef defines a type "treemapfiMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapfi::*treemapfiMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapfi : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapfiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapfi(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapfi * m = new Tamgutreemapfi;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapfiMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapfi::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(string& n) {
        ...
        locking();
        try {
            Tamgu* res = globalTamgu->Provideint(values.at(v));
            unlocking();
            return res;
        }
        catch(const std::out_of_range& oor) {
    ...
    Tamgu* Value(long n) {
        locking();
        try {
            Tamgu* res = globalTamgu->Provideint(values.at(n));
            unlocking();
            return res;
        }
        catch(const std::out_of_range& oor) {
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapfi : public TamguIteration {
    public:

    map<double, long>::iterator it;
    Tamgutreemapfi map;

    TamguIterationtreemapfi(Tamgutreemapfi* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
