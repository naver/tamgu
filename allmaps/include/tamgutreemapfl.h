...
#ifndef Tamgutreemapfl_h
#define Tamgutreemapfl_h
...
class Tamgutreemapfl;
//This typedef defines a type "treemapflMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapfl::*treemapflMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapfl : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapflMethod> methods;
    ...
    map<double, BLONG> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapfl(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapfl * m = new Tamgutreemapfl;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapflMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapfl::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapfl : public TamguIteration {
    public:

    map<double, BLONG>::iterator it;
    Tamgutreemapfl map;

    TamguIterationtreemapfl(Tamgutreemapfl* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
