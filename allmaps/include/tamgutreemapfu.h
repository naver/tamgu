...
#ifndef Tamgutreemapfu_h
#define Tamgutreemapfu_h
...
class Tamgutreemapfu;
//This typedef defines a type "treemapfuMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapfu::*treemapfuMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapfu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapfuMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapfu(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Tamgutreemapfu * m = new Tamgutreemapfu;
            m->values = values;
            return m;
        }
        return this;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        map<double,wstring>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapfuMethod func, unsigned long arity, string infos);
    ...
    Tamgu* Value(long n) {
        ...
        if (values.find((double)n) == values.end())
            return aNOELEMENT;
        return globalTamgu->Provideustring(values[(double)n]);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapfu : public TamguIteration {
    public:

    map<double, wstring>::iterator it;
    Tamgutreemapfu map;

    TamguIterationtreemapfu(Tamgutreemapfu* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
