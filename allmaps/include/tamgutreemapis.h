...
#ifndef Tamgutreemapis_h
#define Tamgutreemapis_h
...
class Tamgutreemapis;
//This typedef defines a type "treemapisMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapis::*treemapisMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapis : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapisMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapis(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Tamgutreemapis * m = new Tamgutreemapis;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapisMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapis : public TamguIteration {
    public:

    map<long, string>::iterator it;
    Tamgutreemapis map;

    TamguIterationtreemapis(Tamgutreemapis* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
