...
#ifndef Tamgutreemapiu_h
#define Tamgutreemapiu_h
...
class Tamgutreemapiu;
//This typedef defines a type "treemapiuMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapiu::*treemapiuMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapiu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapiuMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapiu(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Tamgutreemapiu * m = new Tamgutreemapiu;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapiuMethod func, unsigned long arity, string infos);
    ...
    Tamgu* Value(Tamgu* a) {
        ...
        if (values.find((long)n) == values.end())
            return aNOELEMENT;
        return globalTamgu->Provideustring(values[(long)n]);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapiu : public TamguIteration {
    public:

    map<long, wstring>::iterator it;
    Tamgutreemapiu map;

    TamguIterationtreemapiu(Tamgutreemapiu* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
