...
#ifndef Tamgutreemapl_h
#define Tamgutreemapl_h
...
class Tamgutreemapl;
//This typedef defines a type "treemaplMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapl::*treemaplMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapl : public TamguObjectLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemaplMethod> methods;
    ...
    map<BLONG, Tamgu*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapl(TamguGlobal* g, Tamgu* parent = NULL) : TamguObjectLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced) {
            Tamgutreemapl* m = new Tamgutreemapl;
            locking();
            Tamgu* v;
    ...
    Tamgu* Newinstance(short idthread, Tamgu* f = NULL) {
        return new Tamgutreemapl();
    }

    Exporting TamguIteration* Newiteration(bool direction);


    static void AddMethod(TamguGlobal* g, string name, treemaplMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapl::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapl : public TamguIteration {
    public:
    ...
    TamguIterationtreemapl(Tamgutreemapl* m, bool d, TamguGlobal* g = NULL) : map(m), _lock(m), TamguIteration(d, g) {}
