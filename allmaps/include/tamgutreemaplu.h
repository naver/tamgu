...
#ifndef Tamgutreemaplu_h
#define Tamgutreemaplu_h
...
class Tamgutreemaplu;
//This typedef defines a type "treemapluMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemaplu::*treemapluMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemaplu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapluMethod> methods;
    ...
    map<BLONG, wstring> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemaplu(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Tamgutreemaplu * m = new Tamgutreemaplu;
            m->values = values;
            return m;
        }
        return this;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        map<BLONG,wstring>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapluMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemaplu : public TamguIteration {
    public:

    map<BLONG, wstring>::iterator it;
    Tamgutreemaplu map;

    TamguIterationtreemaplu(Tamgutreemaplu* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
