...
#ifndef Tamgutreemapuf_h
#define Tamgutreemapuf_h
...
class Tamgutreemapuf;
//This typedef defines a type "treemapufMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapuf::*treemapufMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapuf : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapufMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapuf(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapuf * m = new Tamgutreemapuf;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        double val=a->Float();
        map<wstring,double>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapufMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapuf::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapuf : public TamguIteration {
    public:

    map<wstring, double>::iterator it;
    Tamgutreemapuf map;

    TamguIterationtreemapuf(Tamgutreemapuf* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
