...
#ifndef Tamgutreemapul_h
#define Tamgutreemapul_h
...
class Tamgutreemapul;
//This typedef defines a type "treemapulMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapul::*treemapulMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapul : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapulMethod> methods;
    ...
    map<wstring, BLONG> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapul(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapul * m = new Tamgutreemapul;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    double Sum() {
        locking();
        double v = 0;
        map<wstring, BLONG>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        BLONG val=a->Long();
        map<wstring,BLONG>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapulMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapul::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapul : public TamguIteration {
    public:

    map<wstring, BLONG>::iterator it;
    Tamgutreemapul map;

    TamguIterationtreemapul(Tamgutreemapul* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
