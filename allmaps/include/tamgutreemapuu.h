...
#ifndef Tamgutreemapuu_h
#define Tamgutreemapuu_h
...
class Tamgutreemapuu;
//This typedef defines a type "treemapuuMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapuu::*treemapuuMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapuu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapuuMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapuu(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapuu * m = new Tamgutreemapuu;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        map<wstring,wstring>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapuuMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapuu::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapuu : public TamguIteration{
    public:

    map<wstring,wstring > ::iterator it;
    Tamgutreemapuu map;

    TamguIterationtreemapuu(Tamgutreemapuu * m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
