...
void Tamgua_mapfu::Setidtype(TamguGlobal* global) {
  Locking lock(classlock);
  if (Tamgua_mapfu::methods.isEmpty())
    Tamgua_mapfu::InitialisationModule(global,"");
}
...
bool Tamgua_mapfu::InitialisationModule(TamguGlobal* global, string version) {
    ...
    global->RecordCompatibilities(Tamgua_mapfu::idtype);
