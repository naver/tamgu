...
Exporting bin_hash<unsigned long> Tamgua_mapfu::exported;
...
Exporting Tamgu*  Tamgua_mapfu::Put(Tamgu* idx, Tamgu* ke, short idthread) {
    ...
    setvalue(idx->Float(),  vl);
    return aTRUE;
}

Exporting Tamgu* Tamgua_mapfu::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
    if (!idx->isIndex()) {
