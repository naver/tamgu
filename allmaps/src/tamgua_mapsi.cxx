...
bool Tamgua_mapsi::InitialisationModule(TamguGlobal* global, string version) {
    ...
    global->RecordMethods(Tamgua_mapsi::idtype, Tamgua_mapsi::exported);
...
Exporting Tamgu*  Tamgua_mapsi::Put(Tamgu* idx, Tamgu* ke, short idthread) {
    ...
    values.set(idx->String(),  ke->Integer());
    return aTRUE;
}

Exporting Tamgu* Tamgua_mapsi::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
    if (!idx->isIndex()) {
