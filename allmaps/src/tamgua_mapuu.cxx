...
bool Tamgua_mapuu::InitialisationModule(TamguGlobal* global, string version) {
    ...
    global->RecordMethods(Tamgua_mapuu::idtype, Tamgua_mapuu::exported);
...
Exporting Tamgu*  Tamgua_mapuu::Put(Tamgu* idx, Tamgu* ke, short idthread) {
    ...
    setvalue(idx->UString(),  vl);
    return aTRUE;
}

Exporting Tamgu* Tamgua_mapuu::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
    if (!idx->isIndex()) {
