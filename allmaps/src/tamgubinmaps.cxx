...
Exporting bin_hash<unsigned long> Tamgubinmaps::exported;
...
Exporting Tamgu* Tamgubinmaps::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
    ...
    return globalTamgu->Providestring(values.get(skey));
}
