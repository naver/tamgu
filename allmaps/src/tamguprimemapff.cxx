...
void Tamguprimemapff::Setidtype(TamguGlobal* global) {
  ...
  if (Tamguprimemapff::methods.isEmpty())
...
bool Tamguprimemapff::InitialisationModule(TamguGlobal* global, string version) {
    ...
    global->returnindextypes[Tamguprimemapff::idtype] = a_float;
...
Exporting Tamgu* Tamguprimemapff::divideinteger(Tamgu* b, bool itself) {
    Doublelocking _lock(this, b);
