...
const char e_argument_shoud_be[] = "Argument shoud be a function";
const char e_argument_should_be[] = "Argument should be an uvector";
const char e_can_only_append[] = "Can only 'append' to a list";
...
const char e_cannot_assign_or[] = "Cannot assign or test a feature to this dependency node";
...
const char e_cannot_process_indexes[] = "Cannot process indexes";
...
const char e_cannot_set_this[] = "Cannot set this value";
const char e_cannot_store_this[] = "Cannot store this value at this position: wrong size";
const char e_cannot_these_two[] = "Cannot '::' these two elements";
...
const char e_error_mismatch_argument[] = "Error: mismatch argument in a taskell function call to: ";
...
const char e_wrong_assignement_expected[] = "Wrong assignement: Expected a taskell function";
...
const char e_wrong_frame_assignment[] = "Wrong frame assignment";
