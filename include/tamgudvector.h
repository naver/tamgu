...
class Tamgudvector : public TamguLockContainer {
    ...
    Tamgu* MethodCosine(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return new Tamgudecimal(cosine_similarity(((Tamgudvector*)v)->values));
    }
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgudvector::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    float cosine_similarity(std::vector<float>& v) {
    ...
    Exporting Tamgu* shiftright(Tamgu* a, bool itself);Exporting Tamgu* mod(Tamgu* a, bool itself);
