...
public:
	...
	void Methods(Tamgu* v) {
            for (const auto& it : globalTamgu->infomethods[a_float])
                 v->storevalue(it.first);
      }

      string Info(string n) {
            if (globalTamgu->infomethods[a_float].find(n) !=  globalTamgu->infomethods[a_float].end())
              return globalTamgu->infomethods[a_float][n];
    ...
    Tamgu* MethodMantissa(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return globalTamgu->ProvideConstfloat(result);
    }
	...
	Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
		...
		return (this->*Tamgufloat::methods.get(idname))(contextualpattern, idthread, callfunc);
	}
	...
	Tamgu* andset(Tamgu* a, bool itself) {
		...
		return globalTamgu->ProvideConstfloat(DoubleAnd(value, a->Float()));
	}
	...
	Tamgu* orset(Tamgu* a, bool itself) {
        ...
        return globalTamgu->ProvideConstfloat(DoubleOr(value, a->Float()));
	}
	...
	Tamgu* xorset(Tamgu* a, bool itself) {
        ...
        return globalTamgu->ProvideConstfloat(DoubleXor(value, a->Float()));
	}
	...
	Tamgu* shiftleft(Tamgu* a, bool itself) {
        ...
        return globalTamgu->ProvideConstfloat(d.v);
	}
...
public:
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
            //This call is a bit cryptic. It takes the method (function) pointer that has been associated in our map with "name"
            //and run it with the proper parameters. This is the right call which should be invoked from within a class definition
        return (this->*Tamguatomicfloat::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
