...
class Tamguivector : public TamguLockContainer {
    ...
    void Methods(Tamgu* v) {
            for (const auto& it : globalTamgu->infomethods[a_ivector])
                 v->storevalue(it.first);
      }

      string Info(string n) {
            if (globalTamgu->infomethods[a_ivector].find(n) !=  globalTamgu->infomethods[a_ivector].end())
              return globalTamgu->infomethods[a_ivector][n];
    ...
    Tamgu* MethodCosine(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return globalTamgu->Providefloat(cosine_similarity(((Tamguivector*)v)->values));
    }
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguivector::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    double cosine_similarity(std::vector<long>& v) {
...
public:
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
            //This call is a bit cryptic. It takes the method (function) pointer that has been associated in our map with "name"
            //and run it with the proper parameters. This is the right call which should be invoked from within a class definition
        return (this->*Tamgua_ivector::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
