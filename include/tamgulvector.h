...
class Tamgulvector : public TamguLockContainer {
    ...
    void Methods(Tamgu* v) {
            for (const auto& it : globalTamgu->infomethods[a_lvector])
                 v->storevalue(it.first);
      }

      string Info(string n) {
            if (globalTamgu->infomethods[a_lvector].find(n) !=  globalTamgu->infomethods[a_lvector].end())
              return globalTamgu->infomethods[a_lvector][n];
    ...
    Tamgu* MethodCosine(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return globalTamgu->Providefloat(cosine_similarity(((Tamgulvector*)v)->values));
    }
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgulvector::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    double cosine_similarity(std::vector<BLONG>& v) {
