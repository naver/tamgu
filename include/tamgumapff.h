...
class Tamgumapff : public TamguLockContainer {
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgumapff::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(string& n) {
        ...
        Tamgu* res = globalTamgu->ProvideConstfloat(values[v]);
        unlocking();
        return res;        
    }
    ...
    Tamgu* Value(long n) {
        ...
        Tamgu* res = globalTamgu->ProvideConstfloat(values[(double)n]);
        unlocking();
        return res;        
    }
