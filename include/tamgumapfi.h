...
class Tamgumapfi;
//This typedef defines a type "mapfiMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapfi::*mapfiMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapfi : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapfiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapfi(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    static void AddMethod(TamguGlobal* global, string name, mapfiMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgumapfi::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(string& n) {
        ...
        locking();
        try {
            Tamgu* res = globalTamgu->ProvideConstint(values.at(v));
            unlocking();
            return res;
        }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapfi : public TamguIteration {
    public:

    hmap<double, long>::iterator it;
    Tamgumapfi map;

    TamguIterationmapfi(Tamgumapfi* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
