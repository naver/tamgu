...
class Tamgumapfl;
//This typedef defines a type "mapflMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapfl::*mapflMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapfl : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapflMethod> methods;
    ...
    hmap<double, BLONG> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapfl(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    double Sum() {
        locking();
        double v = 0;
        hmap<double, BLONG>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        BLONG val=a->Long();
        hmap<double,BLONG>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapflMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgumapfl::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapfl : public TamguIteration {
    public:

    hmap<double, BLONG>::iterator it;
    Tamgumapfl map;

    TamguIterationmapfl(Tamgumapfl* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
