...
class Tamgumapfs;
//This typedef defines a type "mapfsMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapfs::*mapfsMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapfs : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapfsMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapfs(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        string val=a->String();
        hmap<double,string>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapfsMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapfs : public TamguIteration {
    public:

    hmap<double, string>::iterator it;
    Tamgumapfs map;

    TamguIterationmapfs(Tamgumapfs* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
