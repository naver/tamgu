...
class Tamgumapfu;
//This typedef defines a type "mapfuMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapfu::*mapfuMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapfu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapfuMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapfu(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        hmap<double,wstring>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapfuMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapfu : public TamguIteration {
    public:

    hmap<double, wstring>::iterator it;
    Tamgumapfu map;

    TamguIterationmapfu(Tamgumapfu* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
