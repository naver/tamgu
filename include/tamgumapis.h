...
class Tamgumapis;
//This typedef defines a type "mapisMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapis::*mapisMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapis : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapisMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapis(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    static void AddMethod(TamguGlobal* global, string name, mapisMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapis : public TamguIteration {
    public:

    hmap<long, string>::iterator it;
    Tamgumapis map;

    TamguIterationmapis(Tamgumapis* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
