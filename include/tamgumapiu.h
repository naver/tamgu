...
class Tamgumapiu;
//This typedef defines a type "mapiuMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapiu::*mapiuMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapiu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapiuMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapiu(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        hmap<long,wstring>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapiuMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapiu : public TamguIteration {
    public:

    hmap<long, wstring>::iterator it;
    Tamgumapiu map;

    TamguIterationmapiu(Tamgumapiu* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
