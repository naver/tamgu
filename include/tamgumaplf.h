...
class Tamgumaplf;
//This typedef defines a type "maplfMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumaplf::*maplfMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumaplf : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<maplfMethod> methods;
    ...
    hmap<BLONG, double> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgumaplf(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    double Sum() {
        locking();
        double v = 0;
        hmap<BLONG, double>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        double val=a->Float();
        hmap<BLONG,double>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, maplfMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgumaplf::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmaplf : public TamguIteration {
    public:

    hmap<BLONG, double>::iterator it;
    Tamgumaplf map;

    TamguIterationmaplf(Tamgumaplf* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
