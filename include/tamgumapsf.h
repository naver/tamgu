...
class Tamgumapsf;
//This typedef defines a type "mapsfMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapsf::*mapsfMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapsf : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapsfMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapsf(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        double val=a->Float();
        hmap<string,double>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapsfMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapsf : public TamguIteration {
    public:

    hmap<string, double>::iterator it;
    Tamgumapsf map;

    TamguIterationmapsf(Tamgumapsf* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
