...
class Tamgumapsl;
//This typedef defines a type "mapslMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapsl::*mapslMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapsl : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapslMethod> methods;
    ...
    hmap<string, BLONG> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapsl(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    double Sum() {
        locking();
        double v = 0;
        hmap<string, BLONG>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        BLONG val=a->Long();
        hmap<string,BLONG>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapslMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgumapsl::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapsl : public TamguIteration {
    public:

    hmap<string, BLONG>::iterator it;
    Tamgumapsl map;

    TamguIterationmapsl(Tamgumapsl* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
