...
class Tamgumapuf;
//This typedef defines a type "mapufMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapuf::*mapufMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapuf : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapufMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapuf(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        double val=a->Float();
        hmap<wstring,double>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapufMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapuf : public TamguIteration {
    public:

    hmap<wstring, double>::iterator it;
    Tamgumapuf map;

    TamguIterationmapuf(Tamgumapuf* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
