...
class Tamgumapul;
//This typedef defines a type "mapulMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapul::*mapulMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapul : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapulMethod> methods;
    ...
    hmap<wstring, BLONG> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgumapul(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    double Sum() {
        locking();
        double v = 0;
        hmap<wstring, BLONG>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        BLONG val=a->Long();
        hmap<wstring,BLONG>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapulMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgumapul::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapul : public TamguIteration {
    public:

    hmap<wstring, BLONG>::iterator it;
    Tamgumapul map;

    TamguIterationmapul(Tamgumapul* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
