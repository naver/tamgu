...
class Tamgumapuu;
//This typedef defines a type "mapuuMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgumapuu::*mapuuMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgumapuu : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<mapuuMethod> methods;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        hmap<wstring,wstring>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, mapuuMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgumapuu::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationmapuu : public TamguIteration{
    public:

    hmap<wstring,wstring > ::iterator it;
    Tamgumapuu map;

    TamguIterationmapuu(Tamgumapuu * m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
