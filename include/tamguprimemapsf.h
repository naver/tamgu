...
class Tamguprimemapsf : public TamguLockContainer {
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemapsf::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(Tamgu* a) {
        ...
        Tamgu* res = globalTamgu->ProvideConstfloat(values[n]);
        unlocking();
        return res;        
    }
    ...
    Tamgu* Value(long n) {
        ...
        Tamgu* res = globalTamgu->ProvideConstfloat(values[s]);
        unlocking();
        return res;        
    }
