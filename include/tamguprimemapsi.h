...
#ifndef Tamguprimemapsi_h
#define Tamguprimemapsi_h
...
class Tamguprimemapsi;
//This typedef defines a type "primemapsiMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemapsi::*primemapsiMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemapsi : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemapsiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemapsi(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamguprimemapsi * m = new Tamguprimemapsi;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    double Sum() {
        locking();
        double v = 0;
        prime_hash<string, long>::iterator itx;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        if (a->isContainer()) {
            ...
            for (it->Begin(); it->End() == aFALSE; it->Next()) {
                m->values[it->Keystring()]=it->Valueinteger();
            }
            it->Release();
            return m;
        }
        ...
        long val=a->Integer();
        prime_hash<string,long>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, primemapsiMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<string, long>::iterator itr;
        Tamguprimemapsi* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Tamguprimemapsi;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemapsi::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(Tamgu* a) {
        ...
        Tamgu* res = globalTamgu->ProvideConstint(values[n]);
        unlocking();
        return res;        
    }
    ...
    Tamgu* Value(long n) {
        ...
        Tamgu* res = globalTamgu->ProvideConstint(values[s]);
        unlocking();
        return res;        
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemapsi : public TamguIteration {
    public:

    prime_hash<string, long>::iterator it;
    Tamguprimemapsi map;

    TamguIterationprimemapsi(Tamguprimemapsi* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
