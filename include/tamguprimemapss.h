...
#ifndef Tamguprimemapss_h
#define Tamguprimemapss_h
...
class Tamguprimemapss;
//This typedef defines a type "primemapssMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprimemapss::*primemapssMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamguprimemapss : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<primemapssMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamguprimemapss(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamguprimemapss * m = new Tamguprimemapss;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        string val=a->String();
        prime_hash<string,string>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, primemapssMethod func, unsigned long arity, string infos);
    ...
    Tamgu* MethodItems(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        prime_hash<string, string>::iterator itr;
        Tamguprimemapss* item;
        Tamgu* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Tamguprimemapss;
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamguprimemapss::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
    ...
    Tamgu* Value(Tamgu* a) {
        ...
        Tamgu* res = globalTamgu->Providestring(values[n]);
        unlocking();
        return res;        
    }
    ...
    Tamgu* Value(long n) {
        ...
        Tamgu* res = globalTamgu->Providestring(values[s]);
        unlocking();
        return res;        
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationprimemapss : public TamguIteration{
    public:

    prime_hash<string,string > ::iterator it;
    Tamguprimemapss map;

    TamguIterationprimemapss(Tamguprimemapss * m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
