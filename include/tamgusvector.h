...
class Tamgusvector : public TamguLockContainer {
    ...
    void Methods(Tamgu* v) {
            for (const auto& it : globalTamgu->infomethods[a_svector])
                 v->storevalue(it.first);
      }

      string Info(string n) {
            if (globalTamgu->infomethods[a_svector].find(n) !=  globalTamgu->infomethods[a_svector].end())
              return globalTamgu->infomethods[a_svector][n];
    ...
    Tamgu* MethodMin(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return globalTamgu->Providestring(m);
    }
    ...
    Tamgu* MethodMinMax(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        Tamgusvector* b = new Tamgusvector;
    ...
    Tamgu* MethodLast(Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        contextualpattern = globalTamgu->Providestring(values.back());
        unlocking();
