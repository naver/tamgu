...
#ifndef Tamgutreemapsf_h
#define Tamgutreemapsf_h
...
class Tamgutreemapsf;
//This typedef defines a type "treemapsfMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapsf::*treemapsfMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapsf : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapsfMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapsf(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapsf * m = new Tamgutreemapsf;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        double val=a->Float();
        map<string,double>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapsfMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapsf::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapsf : public TamguIteration {
    public:

    map<string, double>::iterator it;
    Tamgutreemapsf map;

    TamguIterationtreemapsf(Tamgutreemapsf* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
