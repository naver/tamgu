...
#ifndef Tamgutreemapsl_h
#define Tamgutreemapsl_h
...
class Tamgutreemapsl;
//This typedef defines a type "treemapslMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapsl::*treemapslMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapsl : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapslMethod> methods;
    ...
    map<string, BLONG> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Tamgutreemapsl(TamguGlobal* g, Tamgu* parent = NULL) : TamguLockContainer(g, parent) {
    ...
    Tamgu* Atom(bool forced) {
        if (forced || !protect || reference) {
            locking();
            Tamgutreemapsl * m = new Tamgutreemapsl;
            m->values = values;
            unlocking();
            return m;
        }
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapslMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapsl::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapsl : public TamguIteration {
    public:

    map<string, BLONG>::iterator it;
    Tamgutreemapsl map;

    TamguIterationtreemapsl(Tamgutreemapsl* m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
