...
#ifndef Tamgutreemapss_h
#define Tamgutreemapss_h
...
class Tamgutreemapss;
//This typedef defines a type "treemapssMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutreemapss::*treemapssMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Tamgutreemapss : public TamguLockContainer {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging basebin_hash<treemapssMethod> methods;
    ...
    Tamgu* Newvalue(Tamgu* a, short idthread) {
        ...
        string val=a->String();
        map<string,string>::iterator ist;
    ...
    static void AddMethod(TamguGlobal* global, string name, treemapssMethod func, unsigned long arity, string infos);
    ...
    Tamgu* CallMethod(short idname, Tamgu* contextualpattern, short idthread, TamguCall* callfunc) {
        ...
        return (this->*Tamgutreemapss::methods.get(idname))(contextualpattern, idthread, callfunc);
    }
...
//--------------------------------------------------------------------------------------------------
class TamguIterationtreemapss : public TamguIteration{
    public:

    map<string,string > ::iterator it;
    Tamgutreemapss map;

    TamguIterationtreemapss(Tamgutreemapss * m, bool d, TamguGlobal* g = NULL) : TamguIteration(d, g) {
        map.values = m->values;
    }
