...
class LispE {
    ...
    vecter<Stackelement*> stack_pool;

    vecter<Stackelement*> execution_stack;
...
public:
    ...
    vecter<Floatspool*> floats_pool;
    vecter<Numberspool*> numbers_pool;
    vecter<Integerspool*> integers_pool;
    vecter<Stringspool*> strings_pool;

    vecter<Set_spool*> sets_pool;
    vecter<Set_npool*> setn_pool;
    vecter<Set_ipool*> seti_pool;
    vecter<Setpool*> set_pool;

    vecter<Dictionarypool*> dictionary_pool;
    vecter<Dictionary_npool*> dictionaryn_pool;
    vecter<Dictionary_ipool*> dictionaryi_pool;

    vecter<Treepool*> tree_pool;
    vecter<Tree_npool*> treen_pool;
    vecter<Tree_ipool*> treei_pool;

    vecter<Listpool*> list_pool;
    
    vecter<Quotedpool*> quoted_pool;
    
    vecter<Returnpool*> return_pool;

    vecter<Element*> composition_stack;
    vecter<Element*> clean_compositions;
    //------------------------------------------
    ...
    Element* tensor_to_lispe(Element* e, vecter<long>& shape);
