...
Exporting string cstr_unicode_to_utf8(UWCHAR code);
...
void s_split(wstring& s, wstring& splitter, vector<wstring>& strs, bool keepblanks);
...
Exporting void str_utf16_to_utf8_clean(string& s, wstring& str);

Exporting void str_unicode_to_utf8(string& s, wchar_t* str, long sz);
Exporting void str_unicode_to_utf8(string& s, wstring& str);
Exporting void str_unicode_to_utf8_clean(string& s, wstring& str);

Exporting void str_unicode_to_utf8(string& s, u_ustring& str);
...
public:
    ...
    UWCHAR get_a_char(u_ustring& s, long& i);
    string get_a_char(string& s, long& i);
