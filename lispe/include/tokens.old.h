...
public:
    ...
    void setrules(vecter_n<u_ustring>& r) {
        reset();
        rules=r;
        parserules();
        loaded = true;
    ...
    void getrules(vecter_n<u_ustring>& r) {
        if (!rules.size()) {
            setrules();
            r=rules;
            rules.clear();
    ...
    void apply(u_ustring& toparse, vecter_n<u_ustring>* vstack);
    ...
    void tokenize(u_ustring& thestr, vecter_n<u_ustring>* vstack) {
