...
static char tab16[]={'+','*',0};
static char tab17[]={'@','~','#',0};
static const char* varstring33="exclusive";
static const char* varstring20="elif";
static const char* varstring86="concept";
static const char* varstring62="all";
static const char* varstring70="dropWhile";
static const char* varstring13="const";
static const char* varstring89="true";
static const char* varstring0="ifnot";
static const char* varstring29="...";
static const char* varstring26="return";
static const char* varstring67="scanr1";
static const char* varstring49="stop";
static const char* varstring64="foldl1";
static const char* varstring34="break";
...
static const char* varstring59="foldr";
static const char* varstring21="frame";
static const char* varstring54="static";
static const char* varstring58="foldl";
static const char* varstring48="fail";
static const char* varstring9="xor";
static const char* varstring18="for";
static const char* varstring32="protected";
static const char* varstring65="foldr1";
static const char* varstring82="let";
static const char* varstring85="ontology";
static const char* varstring75="zip";
static const char* varstring28="extension";
static const char* varstring81="of";
static const char* varstring69="filter";
static const char* varstring7="or";
static const char* varstring39="otherwise";
static const char* varstring11="private";
static const char* varstring22="polynomial";
static const char* varstring3="×";
static const char* varstring60="scanl";
static const char* varstring2="∨";
static const char* varstring44="from";
static const char* varstring46="..";
static const char* varstring1="∧";
static const char* varstring30="strict";
static const char* varstring78="replicate";
static const char* varstring24="autorun";
static const char* varstring15="IF";
static const char* varstring4="÷";
static const char* varstring74="zipWith";
static const char* varstring61="scanr";
static const char* varstring23="function";
...
static const char* varstring25="thread";
static const char* varstring45="¬";
static const char* varstring79="flip";
static const char* varstring10="≠";
static const char* varstring57="→";
static const char* varstring17="while";
static const char* varstring55="←";
static const char* varstring40="²";
static const char* varstring41="³";
static const char* varstring88="property";
static const char* varstring8="and";
static const char* varstring90="false";
static const char* varstring68="takeWhile";
static const char* varstring91="do";
static const char* varstring5="is";
static const char* varstring66="scanl1";
static const char* varstring36="in";
...
static const char* varstring73="map";
static const char* varstring76="repeat";
static const char* varstring56="Maybe";
static const char* varstring83="deriving";
static const char* varstring84="data";
static const char* varstring77="cycle";
static const char* varstring51="asserta";
static const char* varstring19="switch";
static const char* varstring16="If";
static const char* varstring52="assertz";
...
char bnf_tamgu::m_notatype(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring14) || x_test_string(lret,varstring15) || x_test_string(lret,varstring16) || x_test_string(lret,varstring17) || x_test_string(lret,varstring18) || x_test_string(lret,varstring19) || x_test_string(lret,varstring20) || x_test_string(lret,varstring21) || x_test_string(lret,varstring22) || x_test_string(lret,varstring23) || x_test_string(lret,varstring24) || x_test_string(lret,varstring25) || x_test_string(lret,varstring6) || x_test_string(lret,varstring26))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_protecclusive(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring32) || x_test_string(lret,varstring33))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_functionlabel(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring22) || x_test_string(lret,varstring23) || x_test_string(lret,varstring24) || x_test_string(lret,varstring25))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_notafunction(string& lreturn,x_node** tree) {
    ...
    switch (xs) {
        ...
        break;
        case 'f' :
        if (x_test_string(lret,varstring18) || x_test_string(lret,varstring21) || x_test_string(lret,varstring23))
            found=true;
        break;
        case 'i' :
        ...
        break;
        case 'w' :
        if (x_test_string(lret,varstring17))
            found=true;
        break;
    }
    if (found)
...
char bnf_tamgu::m_blocs_0_1(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (m_extension(lret,&subtree) || m_frame(lret,&subtree) || m_complexbloc(lret,&subtree) || m_function(lret,&subtree) || m_bloc(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_wrong(string& lreturn,x_node** tree) {
    ...
    switch (xs) {
        ...
        break;
        case 'o' :
        if (x_test_string(lret,varstring7) || x_test_string(lret,varstring39))
            found=true;
        break;
        case 'r' :
        if (x_test_string(lret,varstring26))
...
char bnf_tamgu::m_power(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring40) || x_test_string(lret,varstring41))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_notin(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring42) || m_notin_0_1(lret,&subtree) || m_notin_0_2(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_negation(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_in(lret,tab2) || x_test_string(lret,varstring6) || x_test_string(lret,varstring45))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_assertcommandafter(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring52) || x_test_string(lret,varstring53))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_range_0_1_3(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring55) || m_range_0_1_3_4(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_declarationtaskell_0_2_3_4(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring57) || m_declarationtaskell_0_2_3_4_5(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_hlambda_0_2_4(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring57) || m_hlambda_0_2_4_5(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_taskellalloperator(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring62) || x_test_string(lret,varstring63))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_rfold1(string& lreturn,x_node** tree) {
    ...
    int addsubtree=0;
    bool exitonfail=false;
    if (x_test_string(lret,varstring65))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_cycle(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring76) || x_test_string(lret,varstring77))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_taskellcase(string& lreturn,x_node** tree) {
    ...
    //BODYSEQUENCE
    subtree=NULL;
    if (x_test_string(lret,varstring81))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_whereexpression_0_1_2_3_4_5(string& lreturn,x_node** tree) {
    ...
    //BODYOPTIONAL
    subtree=NULL;
    if (x_test_string(lret,varstring82))
        x_init_tree(tree,subtree,addsubtree);
    else
        lret="";
    return(1);
...
char bnf_tamgu::m_hontology_0_1_2_3(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    string lret;
    long pos=currentpos;
    int itok=intoken;
...
char bnf_tamgu::m_hontology_0_1_2(string& lreturn,x_node** tree) {
    ...
    while (currentpos<fx->stack.size()) {
        subtree=NULL;
        if (m_hontology_0_1_2_3(lret,&subtree))
            x_init_tree(tree,subtree,addsubtree);
        else
            break;
    }
...
char bnf_tamgu::m_hontology(string& lreturn,x_node** tree) {
    ...
    //BODYSEQUENCE
    subtree=NULL;
    if (x_test_string(lret,varstring85))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_hconcept(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring86) || x_test_string(lret,varstring87) || x_test_string(lret,varstring88))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_telque_0_1_2_7_14_17_18_19(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_char(lret,'|') || x_test_string(lret,varstring38))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_expression_0_2(string& lreturn,x_node** tree) {
    ...
    switch (xu) {
        ...
        break;
        case 'c':
        if (m_taskellcase(lret,&subtree) || m_tamgulisp(lret,&subtree) || m_call(lret,&subtree) || m_increment(lret,&subtree) || m_allvariable(lret,&subtree))
            found=true;
        break;
        case 'i':
        if (m_localif(lret,&subtree) || m_tamgulisp(lret,&subtree) || m_call(lret,&subtree) || m_increment(lret,&subtree) || m_allvariable(lret,&subtree))
            found=true;
        break;
        case 't':
        case 'f':
        if (m_abool(lret,&subtree) || m_tamgulisp(lret,&subtree) || m_call(lret,&subtree) || m_increment(lret,&subtree) || m_allvariable(lret,&subtree))
            found=true;
        break;
        default:
        if (m_tamgulisp(lret,&subtree) || m_call(lret,&subtree) || m_increment(lret,&subtree) || m_allvariable(lret,&subtree))
            found=true;
    }
    if (found)
        x_init_tree(tree,subtree,addsubtree);
...
char bnf_tamgu::m_abool(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (x_test_string(lret,varstring89) || x_test_string(lret,varstring90))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_tlcomparator(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    static const char* label="tlcomparator";
    string lret;
    long pos=currentpos;
    int itok=intoken;
    x_node* subtree=NULL;
    ...
    //BODYOR
    subtree=NULL;
    if (m_comparator_0_1(lret,&subtree) || m_comparator_0_2(lret,&subtree) || m_comparator_0_3(lret,&subtree) || x_test_string(lret,varstring10) || m_comparator_0_4(lret,&subtree) || m_comparator_0_5(lret,&subtree) || m_comparator_0_6(lret,&subtree) || x_test_in(lret,tab12))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_tloperator(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    static const char* label="tloperator";
    string lret;
    long pos=currentpos;
    int itok=intoken;
    x_node* subtree=NULL;
...
char bnf_tamgu::m_opcomp(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    static const char* label="opcomp";
    string lret;
    long pos=currentpos;
    int itok=intoken;
    x_node* subtree=NULL;
...
char bnf_tamgu::m_tlist_0_2(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    string lret;
    long pos=currentpos;
    int itok=intoken;
...
char bnf_tamgu::m_tlexp(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    static const char* label="tlexp";
    string lret;
    long pos=currentpos;
    int itok=intoken;
    x_node* subtree=NULL;
    ...
    //BODYOR
    subtree=NULL;
    if (m_tlist(lret,&subtree) || m_tlquote(lret,&subtree) || m_tlatom(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_tlistpure_0_2(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    string lret;
    long pos=currentpos;
    int itok=intoken;
...
char bnf_tamgu::m_tlistpure(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    static const char* label="tlistpure";
    string lret;
    long pos=currentpos;
    int itok=intoken;
    x_node* subtree=NULL;
    ...
    //BODYSEQUENCE
    subtree=NULL;
    if (m_tlistpure_0_2(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_tlexpure(string& lreturn,x_node** tree) {
    if (gFail==1) return(0);
    static const char* label="tlexpure";
    string lret;
    long pos=currentpos;
    int itok=intoken;
    x_node* subtree=NULL;
    ...
    //BODYOR
    subtree=NULL;
    if (m_tlistpure(lret,&subtree) || m_tlquotepure(lret,&subtree) || m_tlatom(lret,&subtree))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_akleene(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (m_operator_0_7(lret,&subtree) || m_plusplus_0_1(lret,&subtree) || x_test_in(lret,tab15))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
...
char bnf_tamgu::m_annotationrule_0_2(string& lreturn,x_node** tree) {
    ...
    //BODYOR
    subtree=NULL;
    if (m_range_0_1_3_4(lret,&subtree) || x_test_string(lret,varstring55))
        x_init_tree(tree,subtree,addsubtree);
    else {
        x_pop_node(tree,addsubtree);
        currentpos=pos;
