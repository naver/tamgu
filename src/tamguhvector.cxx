...
Exporting Tamgu* Tamguhvector::getvalue(BLONG i) {
    Locking _lock(this);
    if (i<0 || i>=values.size())
        return aNOELEMENT;
    return new Tamgushort(values[i]);
}
...
Exporting Tamgu* Tamguhvector::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
    Locking _lock(this);
