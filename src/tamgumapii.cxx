...
void Tamgumapii::AddMethod(TamguGlobal* global, string name,mapiiMethod func, unsigned long arity, string infos) {
   ...
   bool Tamgumapii::InitialisationModule(TamguGlobal* global, string version) {
    ...
    #ifdef OLDBACKCOMP
    global->newInstance[global->Getid("iimap")] = new Tamgumapii(global);

    global->RecordMethods(global->Getid("iimap"), Tamgumapii::exported);
    #endif
...
Exporting Tamgu* Tamgumapii::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
