...
Exporting bin_hash<unsigned long> Tamguprimemapsi::exported;
...
void Tamguprimemapsi::AddMethod(TamguGlobal* global, string name,primemapsiMethod func, unsigned long arity, string infos) {
   ...
   bool Tamguprimemapsi::InitialisationModule(TamguGlobal* global, string version) {
    ...
    #ifdef OLDBACKCOMP
    global->newInstance[global->Getid("siprimemap")] = new Tamguprimemapsi(global);

    global->RecordMethods(global->Getid("siprimemap"), Tamguprimemapsi::exported);
    #endif
...
Exporting Tamgu* Tamguprimemapsi::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
