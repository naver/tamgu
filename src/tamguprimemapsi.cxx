...
void Tamguprimemapsi::Setidtype(TamguGlobal* global) {
  ...
  if (Tamguprimemapsi::methods.isEmpty())
...
bool Tamguprimemapsi::InitialisationModule(TamguGlobal* global, string version) {
    ...
    if (version != "") {
        global->returnindextypes[Tamguprimemapsi::idtype] = a_int;        
...
Tamgu* Tamguprimemapsi::EvalWithSimpleIndex(Tamgu* key, short idthread, bool sign) {
    string skey;
