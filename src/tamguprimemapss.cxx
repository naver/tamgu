...
Exporting hmap<string, string> Tamguprimemapss::infomethods;
Exporting bin_hash<unsigned long> Tamguprimemapss::exported;
...
Exporting Tamgu* Tamguprimemapss::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
