...
void Tamgutreemapif::AddMethod(TamguGlobal* global, string name,treemapifMethod func, unsigned long arity, string infos) {
   ...
   bool Tamgutreemapif::InitialisationModule(TamguGlobal* global, string version) {
    ...
    #ifdef OLDBACKCOMP
    global->newInstance[global->Getid("iftreemap")] = new Tamgutreemapif(global);

    global->RecordMethods(global->Getid("iftreemap"), Tamgutreemapif::exported);
    #endif
...
Exporting Tamgu* Tamgutreemapif::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
