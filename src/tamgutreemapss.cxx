...
void Tamgutreemapss::AddMethod(TamguGlobal* global, string name,treemapssMethod func, unsigned long arity, string infos) {
   ...
   bool Tamgutreemapss::InitialisationModule(TamguGlobal* global, string version) {
    ...
    #ifdef OLDBACKCOMP
    global->newInstance[global->Getid("sstreemap")] = new Tamgutreemapss(global);

    global->RecordMethods(global->Getid("sstreemap"), Tamgutreemapss::exported);
    #endif
...
Exporting Tamgu* Tamgutreemapss::Get(Tamgu* contextualpattern, Tamgu* idx, short idthread) {
